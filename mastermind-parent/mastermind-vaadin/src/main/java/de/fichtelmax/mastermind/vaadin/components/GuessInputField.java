...
public class GuessInputField extends VerticalLayout implements DropHandler {
	...
	public GuessInputField() {
		...
		main.addStyleName("dropzone circle");
		main.setWidth("100px");
		main.setHeight("100px");
	...
	public void drop(DragAndDropEvent event) {
		...
		Component sourceComponent = ((DragAndDropWrapper) event
				.getTransferable().getSourceComponent()).iterator().next();
