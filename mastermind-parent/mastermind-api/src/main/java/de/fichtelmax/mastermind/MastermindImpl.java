 ...
 */
// @formatter:on
public class MastermindImpl<T> implements Mastermind<T>
{
     ...
     */
    public MastermindImpl( List<T> solution )
    {
     ...
     */
    @SafeVarargs
    public MastermindImpl( T... solution )
    {
    ...
    public static <T> Mastermind<T> randomSolution( int size, List<T> options )
    {
        ...
        return new MastermindImpl<T>( solution );
    }
    
    /*
     * (non-Javadoc)
     * 
     * @see de.fichtelmax.mastermind.Mastermind#guess(T)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see de.fichtelmax.mastermind.Mastermind#guess(java.util.List)
     */
    @Override
