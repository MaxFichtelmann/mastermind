...
public class DataDrivenTest
{
    ...
    public static Collection<Object[]> collectTestData() throws JAXBException
    {
        ...
        InputStream dataStream = DataDrivenTest.class.getResourceAsStream( "/testdata.xml" );
    ...
    public void test()
    {
        ...
        try
        {
            ...
            assertThat( "Exception was expected!", testData.getExpectedException(), is( nullValue() ) );
            
            assertThat( guessResult, is( notNullValue() ) );
            
            assertThat( guessResult.getDirectHits(), is( equalTo( testData.getExpectedDirect() ) ) );
            assertThat( guessResult.getColorHits(), is( equalTo( testData.getExpectedColor() ) ) );
        }
        catch ( Throwable t )
        {
            ...
            {
                assertThat( t.getClass().getCanonicalName(), is( equalTo( testData.getExpectedException() ) ) );
            }
        }
    }
